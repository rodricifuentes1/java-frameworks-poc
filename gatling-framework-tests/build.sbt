...
// -----------------------------------------------------
// Build information for project gatling-framework-tests
// -----------------------------------------------------
organization := "co.s4n"
name := "gatling-framework-tests"
description := "Tests for micro frameworks using gatling"
